                    ...
                    <ul class="navbar-nav mr-auto">                        
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropleft dropdown-menu drop-left" style="border: 1px solid #495056;border-radius: 0px">
                                ...
                                <a class="dropdown-item" href="<?php echo base_url(); ?>report/upload_rtd" target='_blank'>Upload MPS</a>
                                <button id="mps" class="dropdown-item"></span> MPS</button>
                                <div class="child-st" style="top:69px" id="mps_child">
                                    <a href="<?php echo base_url(); ?>mps.php" class="dropdown-item" target='_blank'>Visayas</a>
                                    <a href="<?php echo base_url(); ?>mps_luzon.php" class="dropdown-item" target='_blank'>Luzon</a>
                                </div>
                                <button id="actual" class="dropdown-item"></span> Actual Outages</button>
                                <div class="child-st" style="top:104px" id="actual_child">
                                    <a href="<?php echo base_url(); ?>actual_outage_visayas.php" class="dropdown-item" target='_blank'>Visayas</a>
                                    <a href="<?php echo base_url(); ?>actual_outage_luzon.php" class="dropdown-item" target='_blank'>Luzon</a>
                                </div>
                                ...
                                <div class="child-st" style="top:140px" id="comparison_child">
                                    <a href="<?php echo base_url(); ?>comparison_out_visayas.php" class="dropdown-item" target='_blank'>Visayas</a>
                                    <a href="<?php echo base_url(); ?>comparison_out_luzon.php" class="dropdown-item" target='_blank'>Luzon</a>
                                </div>
