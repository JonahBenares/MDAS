    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><span class="fa fa-filter"></span> Filter</h5>
            ...
            <input type="button" class="btn btn-info-alt btn-block" value="Apply Filter">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card oh">
                    <div class="card-body">
                        <center>
                            <h2>Outage Capacity by Outage Type
                                <button type="button" class="btn btn-info-alt pull-right animated pulse infinite btn-sm" data-toggle="modal" data-target="#exampleModal">
