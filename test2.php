...
<body>
    ...
    <table cellspacing="0" id="gvMain" style="width: 100%; border-collapse: collapse;position: relative;">
        <tr class="GridViewScrollHeader">
            <td colspan="3" style="background-color: #F4F4F4;">.</td>
            <td colspan="2" style="background-color: #F4F4F4;">.</td>
            <?php for($x=1;$x<=$days;$x++){ ?>
            <th colspan="3" scope="col" class="text-blk"><center><?php echo $x; ?></center></th>
            <?php } ?> 
        ...
        <tr class="GridViewScrollItem" >
            ...
            <td>FR-M94B-38</td>
            <td>375</td>
            <td style="background-color: #ffe1cb">2.68</td>
            ...
            <td style="background: #444444"><h1>Nothing follows</h1></td>
        </tr>
