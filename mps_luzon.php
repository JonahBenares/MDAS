        ...
        <tr>
            <td colspan="20">
                <div class="alert alert-info m-b-0 p-1" role="alert">
                    ...
                    <a href='http://localhost/MDAS/mps_luzon.php' class='remove_filter alert-link pull-right btn btn-xs'>
        ...
        <table class="table" style="border:1px solid #000">
            ...
            <tr class="tr_shaded" style ="<?php echo ($fetch['delivery_hour']==1) ? "background: yellow;" : ''; ?>">
                ...
                ?> 
                    ...
                    <td align="center" style="border-right:2px solid black"> <?php echo get_rtd_value_luzon($conn,"initial", $date, $fetch['resource_id'], $fetch['delivery_hour']); ?></td>
                <?php $range++; } ?>  
            </tr>
            <?php endwhile; ?> 
        </table>
