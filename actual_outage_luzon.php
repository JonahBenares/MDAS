            ...
            <tr>
                ...
                <td width="15%">
                    ...
                    <?php if(!isset($_POST['filter'])){ ?>
                        <a href="report/export_actual_luzon" class="btn btn-md btn-warning-alt btn-sm">Export</a>
                    <?php }else { ?>
                        <a href="report/export_actual_luzon/<?php echo $_POST['year']; ?>/<?php echo $_POST['month']; ?>" class="btn btn-md btn-warning-alt btn-sm">Export</a>
                    <?php } ?>
                </td>
                <td>
